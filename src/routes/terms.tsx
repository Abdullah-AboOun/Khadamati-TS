        ...
        <CardContent className="p-0 space-y-6 leading-relaxed text-sm sm:text-base">
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              بإنشائك حساباً أو استخدامك لمنصة "خدماتي" بأي شكل من الأشكال، فإنك توافق بالكامل على
              الالتزام بجميع هذه الشروط والأحكام. إذا كنت لا توافق عليها، يرجى التوقف عن استخدام المنصة
              فوراً.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              يجب على المستخدم تقديم معلومات دقيقة وحقيقية وكاملة عند إنشاء حسابه وتحديثها دورياً.
              تقع على عاتق المستخدم كامل المسؤولية عن سرية معلومات حسابه وكلمة المرور وعن أي أنشطة
              تتم تحت حسابه.
            </p>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-foreground">
              4. شروط تقديم خدمات الخبراء والمزودين
            </h2>
            <p className="text-muted-foreground">
            ...
            <ul className="list-disc list-inside mr-4 space-y-1.5 text-muted-foreground">
              <li>
                إنجاز الخدمات المطلوبة بأعلى مستويات الاحترافية والجودة والالتزام بالوقت المتفق عليه.
              </li>
              <li>عدم طلب أي مبالغ مالية إضافية خارج إطار الاتفاق الرسمي والمسجل بالمنصة.</li>
              <li>
                احترام العملاء وحفظ سرية تفاصيل الاتصالات والمعلومات الشخصية المستلمة لتنفيذ العمل.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              تحصل منصة خدماتي على عمولة إدارية وتطويرية محددة من كل طلب ناجح ومكتمل (نسبة محددة
              مسبقاً وتخصم تلقائياً). تتم تسوية المستحقات المالية لمزودي الخدمات وإتاحة سحبها فور
              إتمام العميل للطلب وتأكيده.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              يمكن إلغاء الطلب بحرية قبل بدء العمل عليه. في حال نشوء خلاف بين العميل والمزود حول جودة
              التنفيذ أو التسليم، يقوم فريق التحكيم والدعم الفني بمراجعة تفاصيل ومراسلات الطلب
              المخزنة في المنصة وإصدار قرار نهائي ملزم للطرفين بخصوص تسوية التكلفة المالية.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              منصة خدماتي هي وسيط تقني يسهل التواصل وإتمام المعاملات. نحن نبذل قصارى جهدنا لتوثيق
              الحسابات، ولكننا لا نتحمل مسؤولية أي أضرار مباشرة أو غير مباشرة ناتجة عن تعاملات
              المستخدمين خارج إطار الإجراءات الرسمية والآمنة للمنصة.
            </p>
          </section>
        </CardContent>
      </Card>

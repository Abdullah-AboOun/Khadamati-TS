...
import { Route as CheckoutServiceIdRouteImport } from './routes/checkout.service.$id'
...
export interface FileRoutesByFullPath {
  ...
  '/checkout/service/$id': typeof CheckoutServiceIdRoute

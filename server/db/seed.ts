  ...
  const ordersData = [
    {
      ...
      gatewayTxId: "JP-9821431",
      paymentProof: "بوابة جوال باي (Merchant API) - رقم المعاملة: JP-9821431",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "card",
      gatewayTxId: "CC-TX-41123491",
      paymentProof: "بطاقة دفع إلكترونية (Visa/Mastercard) - رقم المعاملة: CC-TX-41123491",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "jawwal_pay",
      gatewayTxId: "JP-5519823",
      paymentProof: "بوابة جوال باي (Merchant API) - رقم المعاملة: JP-5519823",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "card",
      gatewayTxId: "CC-TX-77812903",
      paymentProof: "بطاقة دفع إلكترونية (Visa/Mastercard) - رقم المعاملة: CC-TX-77812903",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "jawwal_pay",
      gatewayTxId: "JP-1123490",
      paymentProof: "بوابة جوال باي (Merchant API) - رقم المعاملة: JP-1123490",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "card",
      gatewayTxId: "CC-TX-99018234",
      paymentProof: "بطاقة دفع إلكترونية (Visa/Mastercard) - رقم المعاملة: CC-TX-99018234",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "jawwal_pay",
      gatewayTxId: "JP-8812903",
      paymentProof: "بوابة جوال باي (Merchant API) - رقم المعاملة: JP-8812903",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "card",
      gatewayTxId: "CC-TX-33102984",
      paymentProof: "بطاقة دفع إلكترونية (Visa/Mastercard) - رقم المعاملة: CC-TX-33102984",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "jawwal_pay",
      gatewayTxId: "JP-4491203",
      paymentProof: "بوابة جوال باي (Merchant API) - رقم المعاملة: JP-4491203",
    ...
    },
    {
      ...
      paymentStatus: "completed",
      paymentMethod: "card",
      gatewayTxId: "CC-TX-11029834",
      paymentProof: "بطاقة دفع إلكترونية (Visa/Mastercard) - رقم المعاملة: CC-TX-11029834",
      details:
        "تصميم متجر إلكتروني لبيع العطور يشمل لوحة تحكم كاملة وإشعارات الطلبات على الواتساب.",
      notes: "تم التأكيد والدفع بنجاح عبر البطاقة.",
      createdAt: daysAgo(4),
      updatedAt: daysAgo(2),
    },
  ];
